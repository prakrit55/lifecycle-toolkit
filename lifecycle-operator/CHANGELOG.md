...
## [0.10.0](https://github.com/prakrit55/lifecycle-toolkit/compare/lifecycle-operator-v0.9.2...lifecycle-operator-v0.10.0) (2024-04-22)
...
* **lifecycle-operator:** adapt KeptnConfig reconciler to set up blockedDeployment parameter ([#3112](https://github.com/prakrit55/lifecycle-toolkit/issues/3112)) ([c8ad8b1](https://github.com/prakrit55/lifecycle-toolkit/commit/c8ad8b1c5157539746d176f8361ca8f1a2f071d8))
* **lifecycle-operator:** adapt KeptnConfig reconciler to set up observabilityTimeout parameter ([#3154](https://github.com/prakrit55/lifecycle-toolkit/issues/3154)) ([f14a1ff](https://github.com/prakrit55/lifecycle-toolkit/commit/f14a1ff586cde3b0ace20d8b89fc6b4a94768630))
...
* **lifecycle-operator:** add Counter meter for promotion phase ([#3105](https://github.com/prakrit55/lifecycle-toolkit/issues/3105)) ([fa146fa](https://github.com/prakrit55/lifecycle-toolkit/commit/fa146face9f02ad6843bac8ba20d1503c2affa03))
...
* **lifecycle-operator:** add namespace to `deploymentduration` metrics ([#3292](https://github.com/prakrit55/lifecycle-toolkit/issues/3292)) ([0735e31](https://github.com/prakrit55/lifecycle-toolkit/commit/0735e31db1967da85e346f9f028a67f178611606))
...
* **lifecycle-operator:** close root spans of failed AppVersions/WorkloadVersions ([#3174](https://github.com/prakrit55/lifecycle-toolkit/issues/3174)) ([120005b](https://github.com/prakrit55/lifecycle-toolkit/commit/120005b48597b286782721d18be8f3605eb59210))
* **lifecycle-operator:** duplicate version in project file ([#2767](https://github.com/prakrit55/lifecycle-toolkit/issues/2767)) ([c7ed8a6](https://github.com/prakrit55/lifecycle-toolkit/commit/c7ed8a69c9af658606761261216e6c00bae5ffa8))
...
* **lifecycle-operator:** make sure spec of KeptnWorkloadVersion is consistent with KeptnWorkload ([#2926](https://github.com/prakrit55/lifecycle-toolkit/issues/2926)) ([f2f8c29](https://github.com/prakrit55/lifecycle-toolkit/commit/f2f8c296a1b7f9746c55c2781c22727c62a2bab3))
* **lifecycle-operator:** remove noops tracer for evaluations ([#3290](https://github.com/prakrit55/lifecycle-toolkit/issues/3290)) ([4948dc5](https://github.com/prakrit55/lifecycle-toolkit/commit/4948dc5f20424bbe9e21c31abbe4c4147b729410))
* **lifecycle-operator:** retrieve KeptnEvaluationDefinition before creating KeptnEvaluation ([#3144](https://github.com/prakrit55/lifecycle-toolkit/issues/3144)) ([54a9b8b](https://github.com/prakrit55/lifecycle-toolkit/commit/54a9b8b85e8ee2fc02cc3cc375104d174fef8eeb))
...
* adapt examples to use v1beta1 API resources ([#2868](https://github.com/prakrit55/lifecycle-toolkit/issues/2868)) ([587773f](https://github.com/prakrit55/lifecycle-toolkit/commit/587773fbea63dbf575879bd3bec447fe55ac4311))
...
* **lifecycle-operator:** clean up leftover logic for supporting standalone Pods as Workloads ([#3140](https://github.com/prakrit55/lifecycle-toolkit/issues/3140)) ([17321bc](https://github.com/prakrit55/lifecycle-toolkit/commit/17321bcd18627479259c963ad2c96c5d0562ac8d))
...
* update golang.org/x/exp digest to 1b97071 ([#2875](https://github.com/prakrit55/lifecycle-toolkit/issues/2875)) ([20f5705](https://github.com/prakrit55/lifecycle-toolkit/commit/20f5705141e252afbe76834be739f305ac3b273a))
...
* update module github.com/argoproj/argo-rollouts to v1.6.5 ([#2892](https://github.com/prakrit55/lifecycle-toolkit/issues/2892)) ([7c8b14f](https://github.com/prakrit55/lifecycle-toolkit/commit/7c8b14f8c09be6995eb341582177dfed8038b7cd))
* update module github.com/argoproj/argo-rollouts to v1.6.6 ([#3061](https://github.com/prakrit55/lifecycle-toolkit/issues/3061)) ([9c4297b](https://github.com/prakrit55/lifecycle-toolkit/commit/9c4297b077b67d921306db6f824839aa425754e9))
* update module github.com/cloudevents/sdk-go/v2 to v2.15.0 ([#2845](https://github.com/prakrit55/lifecycle-toolkit/issues/2845)) ([22dd509](https://github.com/prakrit55/lifecycle-toolkit/commit/22dd5093e263979f466b08f20f72a8763528c957))
* update module github.com/cloudevents/sdk-go/v2 to v2.15.1 ([#3118](https://github.com/prakrit55/lifecycle-toolkit/issues/3118)) ([73c2a31](https://github.com/prakrit55/lifecycle-toolkit/commit/73c2a31ae535ece58f4869aa6fc85e3a0c1a6ae0))
...
* update module sigs.k8s.io/yaml to v1.4.0 ([#2984](https://github.com/prakrit55/lifecycle-toolkit/issues/2984)) ([584aff6](https://github.com/prakrit55/lifecycle-toolkit/commit/584aff65411cca24b69c4efa84428eb8188f05b1))
...
* update opentelemetry-go monorepo (patch) ([#3010](https://github.com/prakrit55/lifecycle-toolkit/issues/3010)) ([a6d1724](https://github.com/prakrit55/lifecycle-toolkit/commit/a6d172444765dbe8e34ae2fd92d390b66afe69f1))
